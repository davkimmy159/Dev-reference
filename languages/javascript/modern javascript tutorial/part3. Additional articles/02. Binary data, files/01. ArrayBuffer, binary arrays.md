...
<img class="icon" src="../../images/commons/icons/triangle-exclamation-solid.svg" /> **`ArrayBuffer` is not an array of something**
...
<img class="icon" src="../../images/commons/icons/triangle-exclamation-solid.svg" /> **No `int8` or similar single-valued types**
...
Here’s a cheatsheet:
![](../../images/03/02/01/arraybuffer-view-buffersource.svg)
