...
1. 요소 내 이미지 그리기
    - [`drawImage`](https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/drawImage) <sub>(메서드)</sub>
2. `Blob` <sub>(객체)</sub> 생성 후 콜백 실행
    - [`toBlob(callback, format, quality)`](https://developer.mozilla.org/en-US/docs/Web/API/HTMLCanvasElement/toBlob) <sub>(메서드)</sub>
