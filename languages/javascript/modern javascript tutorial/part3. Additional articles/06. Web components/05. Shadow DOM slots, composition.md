...
##### 상응 DOM 요소 매칭 <sub>(렌더링 목적)</sub>
- 각 `<slot name="…">` <sub>(Shadow DOM 요소)</sub>
- Light DOM 내 요소 검색 <sub>(브라우저)</sub>
...
##### `slot="…"` <sub>(속성)</sub> 명시
- _"Shadow host"_ 직계 <sub>(최상위)</sub> 자식 요소들 가능
