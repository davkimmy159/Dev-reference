...
<img class="icon" src="../../images/commons/icons/circle-exclamation-solid.svg" /> **Custom element name must contain a hyphen -**
...
<img class="icon" src="../../images/commons/icons/circle-exclamation-solid.svg" /> **Custom elements upgrade**
...
<img class="icon" src="../../images/commons/icons/circle-exclamation-solid.svg" /> **Rendering in `connectedCallback`, not in `constructor`**
