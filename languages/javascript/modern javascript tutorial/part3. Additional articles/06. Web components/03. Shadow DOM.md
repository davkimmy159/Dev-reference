...
- if exists, is rendered by the browser instead of so-called "light DOM" (regular children). In the chapter Shadow DOM slots, composition we'll see how to compose them.
