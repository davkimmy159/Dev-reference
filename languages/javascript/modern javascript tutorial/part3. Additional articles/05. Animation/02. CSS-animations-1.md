...
||||
|---|---|---|
|`ease` <sub>(기본값)</sub>|`(0.25, 0.1, 0.25, 1)`|![ease](../../images/03/05/02/ease.svg)|
|`ease-in`|`(0.42, 0, 1, 1)`||
|`ease-out`|`(0, 0, 0.58, 1)`||
...
||![ease-in](../../images/03/05/02/ease-in.svg)|![ease-out](../../images/03/05/02/ease-out.svg)|![ease-in-out](../../images/03/05/02/ease-in-out.svg)|
