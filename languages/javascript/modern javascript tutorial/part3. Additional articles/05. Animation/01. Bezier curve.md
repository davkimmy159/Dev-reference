...
##### [보간 <sub>(interpolation)</sub>](https://en.wikipedia.org/wiki/Interpolation)
- 다양한 수학 공식 사용 가능
  - [라그랑즈 다항식](https://en.wikipedia.org/wiki/Lagrange_polynomial)
  - [스플라인 보간(spline interpolation)](https://en.wikipedia.org/wiki/Spline_interpolation)
    - 컴퓨터 그래픽스 자주 사용
