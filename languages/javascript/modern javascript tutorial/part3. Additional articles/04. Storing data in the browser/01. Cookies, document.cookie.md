...
<img class="icon" src="../../images/commons/icons/triangle-exclamation-solid.svg" /> **쿠키의 한계**
...
위 코드에서 new RegExp는 `; name=<value>` 패턴을 찾기 위해 동적으로 생성됩니다.
...
<img class="icon" src="../../images/commons/icons/triangle-exclamation-solid.svg" /> **갱신이나 삭제는 동일한 도메인과 경로에서만 해야 합니다.**
