...
- 연결 1개 당 프로세스 1개 실행
  ...
  - 각 프로세스 메모리 일정 부분 사용
    - 자원 소모 多
- resulting in there being as many processes as there are connections, while each process consumes quite a bit of memory. So, too many connections will just consume it all.
