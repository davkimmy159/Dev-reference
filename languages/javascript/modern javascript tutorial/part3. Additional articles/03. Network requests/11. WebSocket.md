...
##### 웹소켓 프로토콜 <sub>([RFC 6455](https://datatracker.ietf.org/doc/html/rfc6455) 명세서)</sub>
- 데이터 교환 시
  - 서버 · 브라우저 간 연결 유지
- 데이터 전달
...
<img src="../../images/commons/icons/circle-exclamation-solid.svg" /> **`wss` <sub>(프로토콜)</sub> 상시 사용 권장**
...
##### `Connection: Upgrade`
- 클라이언트 측 신호 <sub>(프로토콜 변경 요구)</sub> 전송 의미
