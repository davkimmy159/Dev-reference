...
<img class="icon" src="../../images/commons/icons/circle-exclamation-solid.svg" /> **`iframe.onload` vs `iframe.contentWindow.onload`**
...
### Windows on subdomains: `document.domai`n
...
![](../../images/03/01/02/cross-window-messaging.png)
