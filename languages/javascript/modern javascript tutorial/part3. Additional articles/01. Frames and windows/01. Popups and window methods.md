...
- 창 크기 재설정 가능 여부 <sub>(미권장)</sub>

##### `scrollbars` <sub>(`yes` · `no`)</sub>
- 스크롤바 기능 설정 여부 <sub>(미권장)</sub>
...
<img src="../../images/commons/icons/triangle-exclamation-solid.svg" /> **오직 팝업창에서만 동작**
...
- 팝업창 내 `elem` <sub>(요소)</sub> 나타나게 창 스크롤
