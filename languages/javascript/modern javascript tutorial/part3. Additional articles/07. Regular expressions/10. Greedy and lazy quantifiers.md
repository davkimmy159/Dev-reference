...
##### 검색
- 나머지 모든 위치
  - 검색 성공 <sub>(문자열 끝 도달)</sub>

![witch_greedy3](../../images/03/07/10/witch_greedy3.svg)

#### 4. `.` <sub>(패턴 문자)</sub> 반복 <sub>(`.+`)</sub> 종료 후

##### 나머지 패턴 <sub>(`"`)</sub> 검색 시작
- 나머지 문자열 끝 도달
  - 검색 대상 문자열 無

##### 이전 패턴 <sub>(`.+`)</sub> 일치 결과 내 마지막 문자 1개 되돌리기
- 문자열 끝 → 마지막 문자 전
...
#### 5. 이전 패턴 <sub>(`.+`)</sub> 일치 결과 내 마지막 문자 1개 되돌리기
- 마지막 문자 전 → 마지막에서 2번째 문자 전
  - 나머지 패턴 <sub>(`"`)</sub> 검색 위치
