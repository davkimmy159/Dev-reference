...
"site.com my.site.com".match(regexp);
```
...
"my@mail.com @ his@site.com.uk".match(regexp);
```
...
// true
regexp.test('01:32:54:67:89:AB');

// false
// - `:` (콜론) 無
regexp.test('0132546789AB');

// false
// - 숫자 5개
regexp.test('01:32:54:67:89');

// false
// - ZZ (숫자 X)
regexp.test('01:32:54:67:89:ZZ');
```
