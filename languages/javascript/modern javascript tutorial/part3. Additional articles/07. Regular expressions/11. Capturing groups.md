...
<img class="icon" src="../../images/commons/icons/triangle-exclamation-solid.svg" /> **`matchAll` is a new method, polyfill may be needed**
...
<img class="icon" src="../../images/commons/icons/circle-exclamation-solid.svg" /> **Why is a result of `matchAll` an iterable object, not an array?**
