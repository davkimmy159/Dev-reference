...
#### 객체 지향 프로그래밍 <sub>(object-oriented programming, OOP)</sub>
- 객체 사용하여 개체 표현
  - 올바른 개체 선택
...
_**※ 최근 스펙 추가 <sub>(구식 브라우저 폴리필 필요)</sub>**_
