...
<div style="margin-bottom: 10px; padding: 10px 10px 0px 10px; border: 3px solid #797063; border-radius: 10px;">
  <div style="margin-bottom: 16px; font-weight: 900;">
    <img style="vertical-align: middle;" src="./images/commons/icons/triangle-exclamation-solid.svg" />
    <span>
      <code>use strict</code> 취소 방법 X
    </span>
  </div>
...
<div class="box">
  <div class="title">
    ...
    <span>
      <code>let</code> 대신 <code>var</code>
    </span>
  </div>
