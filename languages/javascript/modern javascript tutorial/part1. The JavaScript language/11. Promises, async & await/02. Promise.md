...
<img src="../../images/commons/icons/circle-exclamation-solid.svg" /> **프라미스 : 성공 · 실패만 수행**
...
<img src="../../images/commons/icons/circle-exclamation-solid.svg" /> **처리된 프라미스 핸들러 : 즉각 실행**
...
콜백을 이용한 움직이는 원에서 작성한 함수 `showCircle`를 다시 작성해봅시다. 이번엔 콜백을 받는 대신 프라미스를 반환하도록 해 봅시다.
