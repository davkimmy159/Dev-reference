...
<img src="../../images/commons/icons/circle-exclamation-solid.svg" /> **`Promise` : 성공 · 실패만 수행**
...
<img src="../../images/commons/icons/circle-exclamation-solid.svg" /> **처리된 `Promise` 핸들러 : 즉각 실행**
...
##### `Promise` 기반 지연 실행 함수 <sub>(`delay(ms)`)</sub> 작성
- `Promise` 반환
