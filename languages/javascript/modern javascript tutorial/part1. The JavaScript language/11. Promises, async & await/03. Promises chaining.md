...
##### 동일 프라미스에 등록한 `.then` 핸들러
- 모두 동일 결과 <sub>(`result`)</sub> 받음
  - 모두 `1` 출력

##### 한 프라미스에 핸들러 여러 개 등록하기
- 드물게 사용
- 주로 체이닝 이용
...
<img class="icon" src="../../images/commons/icons/circle-exclamation-solid.svg" /> **`thenable` <sub>(객채)</sub>**
