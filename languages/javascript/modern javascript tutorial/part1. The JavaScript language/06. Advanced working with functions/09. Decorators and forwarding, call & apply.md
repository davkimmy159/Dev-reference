...
### [`function.call`](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Function/call) <sub>(함수 내 내장 메서드)</sub>
...
### [`function.apply`](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Function/apply) <sub>(함수 내 컨텍스트 지정 메서드)</sub>
