...
##### 객체 복제 <sub>(2가지)</sub>
- 얕은 복사 <sub>(중첩 객체 복제 X)</sub>
  - `Object.assign`
- 깊은 복사 <sub>(중첩 객체 복제)</sub>
  - [`_.cloneDeep(obj)`](https://lodash.com/docs/4.17.15#cloneDeep) <sub>(lodash)</sub>

|종류|코드|중첩 객체|
|---|---|---|
|얕은 복사|`Object.assign`|X|
|깊은 복사|[`_.cloneDeep(obj)`](https://lodash.com/docs/4.17.15#cloneDeep) <sub>(lodash)</sub>|O|
