...
#### [`getTime()`](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Date/getTime) <sub>(표준시 메서드 無)</sub>

##### 경과 시간 <sub>(ms · 정수)</sub>
- 1970.1.1 00:00:00 <sub>(경과 기준 일시)</sub> ~ 일시
...
#### [`getTimezoneOffset()`](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Date/getTimezoneOffset) <sub>(표준시 메서드 無)</sub>
