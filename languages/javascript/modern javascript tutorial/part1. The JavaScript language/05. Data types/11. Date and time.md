...
|||
|---|---|
|[`getTime()`](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Date/getTime)|타임스탬프|
|[`getTimezoneOffset()`](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Date/getTimezoneOffset)|현지 · 표준 시간 차이 <sub>(분)</sub>|
