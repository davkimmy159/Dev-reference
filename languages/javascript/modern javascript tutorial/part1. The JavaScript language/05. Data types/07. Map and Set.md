...
##### [SameValueZero](https://tc39.github.io/ecma262/#sec-samevaluezero) 알고리즘 사용 <sub>(값 등가 여부 확인)</sub>
- 라 불리는 알고리즘을 사용해 값의 등가 여부를 확인합니다. 이 알고리즘은 일치 연산자 ===와 거의 유사하지만, NaN과 NaN을 같다고 취급하는 것에서 일치 연산자와 차이가 있습니다. 따라서 맵에선 NaN도 키로 쓸 수 있습니다.
