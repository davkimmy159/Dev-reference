...
### `Object.entries` <sub>(메서드)</sub>

##### `new Map` 생성자 전달 가능 인수 <sub>(초기화 용도)</sub>
...
##### [`Object.entries`](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Object/entries) <sub>(내장 메서드)</sub> 필요
