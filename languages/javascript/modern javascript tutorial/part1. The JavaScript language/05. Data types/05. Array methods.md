...
#### [`lastIndexOf(item, from)`](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Array/lastIndexOf)
- `indexOf` 동일 기능
- 끝부터 검색
...
#### [`includes(item, from)`](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Array/includes)
