...
그런데 현실은 항상 이렇지 않습니다. Ṩ가 하나의 유니코드로 합쳐지는 것은 UTF-16을 만드는 데 참여한 사람들이 Ṩ는 '충분히 나타날 수 있는 사례’라 생각하고, Ṩ를 UTF-16 테이블에 포함하고 코드를 부여해놓았기 때문입니다.
