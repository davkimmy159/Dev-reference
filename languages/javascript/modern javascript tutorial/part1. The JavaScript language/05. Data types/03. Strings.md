...
##### `String.to[[Upper](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/String/toLowerCase)·Lower]Case()` <sub>(메서드)</sub>
```javascript
// INTERFACE
...
#### a. `String.indexOf(substr, [pos])` <sub>(메서드)</sub>

##### `substr` <sub>(부분 문자열)</sub>
- 위치 검색 대상
