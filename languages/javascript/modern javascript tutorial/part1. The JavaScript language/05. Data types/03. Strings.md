...
##### `String.to[Upper·Lower]Case()` <sub>(메서드)</sub>
```javascript
...
#### a. [`String.indexOf(substr, [pos])`](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/String/indexOf) <sub>(메서드)</sub>
...
<img src="../../images/commons/icons/circle-exclamation-solid.svg" /> **[`String.lastIndexOf(substr, [pos])`](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/String/lastIndexOf) <sub>(메서드)</sub>**

##### `String.indexOf` <sub>(메서드)</sub> 유사
