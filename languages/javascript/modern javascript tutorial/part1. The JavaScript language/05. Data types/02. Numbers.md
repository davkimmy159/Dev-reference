...
##### n진법
- 정상 동작 숫자 <sub>(정확히 저장)</sub>
  - x<sup>n</sup> 으로 나눈 값 <sub>(분수)</sub>
- 非정상 동작 <sub>(무한 소수)</sub>
  - 이 외 분수
...
- 정수 대상 수학 연산
  - 비교적 에러 ↓
- 마지막 단계 <sub>(10<sup>n</sup> 나누기)</sub>
  - 소수 다시 등장 <sub>(오류 완전 제거 X)</sub>
```javascript
// 0.3
