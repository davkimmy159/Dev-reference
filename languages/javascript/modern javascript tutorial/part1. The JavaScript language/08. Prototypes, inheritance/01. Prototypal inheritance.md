...
<img src="../../images/commons/icons/circle-exclamation-solid.svg" /> **키 · 값 순회 메서드 · 상속 프로퍼티**

##### 대다수 키 · 값 순회 메서드 <sub>(`Object.[key·value]s` 등)</sub>
- 순회 시 상속 프로퍼티 배제
...
##### `for..in` <sub>(반복문)</sub>
 객체 자체에서 정의한 프로퍼티뿐만 아니라 상속 프로퍼티도 순회 대상에 포함합니다. 반면, 키-값과 관련된 내장 메서드 대부분은 상속 프로퍼티는 제외하고 객체 자체 프로퍼티만을 대상으로 동작합니다.
과제
