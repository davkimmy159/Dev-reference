...
// __proto__ (접근자 프로퍼티) 수정
rabbit.__proto__ = animal;
```

<br />

<img src="../../images/commons/icons/circle-exclamation-solid.svg" /> **`__proto__` ≠ `[[Prototype]]`**

##### 접근자 프로퍼티
- getter <sub>(`[[Prototype]]` 값 접근)</sub>
- setter <sub>(`[[Prototype]]` 값 설정)</sub>
