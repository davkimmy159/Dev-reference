...
- a. 생성자 내 `prototype` <sub>(프로퍼티)</sub> 사이
  - 일반 메서드 상속
- b. 생성자 자체 사이
  - 정적 메서드 · 프로퍼티 상속
```javascript
...
##### `extends` 문법 미사용 → 프로토타입 1개만 설정
- 생성자 내 `prototype` <sub>(프로퍼티)</sub> 사이
  - 일반 메서드 상속
- 생성자 자체 사이 X
  - 정적 메서드 · 프로퍼티 상속 X
```javascript
