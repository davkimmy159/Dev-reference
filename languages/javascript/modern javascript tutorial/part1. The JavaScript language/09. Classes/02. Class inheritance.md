...
<img src="../../images/commons/icons/circle-exclamation-solid.svg" /> **화살표 함수 : `super` X <sub>(미지원)</sub>**
...
##### 4. `super` <sub>(키워드)</sub> · `[[HomeObject]]`
