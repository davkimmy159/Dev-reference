...
<img src="../../images/commons/icons/triangle-exclamation-solid.svg" /> **`?` <sub>(조건부 연산자)</sub> · `break` · `continue` <sub>(지시자)</sub>**
