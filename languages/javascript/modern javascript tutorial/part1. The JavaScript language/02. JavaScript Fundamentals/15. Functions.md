...
<img src="../../images/commons/icons/circle-exclamation-solid.svg" /> **`return` <sub>(문)</sub> 無 · `return` <sub>(지시자)</sub> 값 생략**

<img src="../../images/commons/icons/circle-exclamation-solid.svg" /> **값 미반환 함수 `undefined` 반환**
