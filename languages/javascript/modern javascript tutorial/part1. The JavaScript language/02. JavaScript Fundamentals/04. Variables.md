...
<img class="icon" src="../../images/commons/icons/circle-exclamation-solid.svg" /> **재사용 vs 새로 만들기**
...
- 대문자 상수 바꾸기 절절성
```javascript
const BIRTHDAY = '18.04.1982';  // 대문자 상수 적절?
const AGE = someCode(BIRTHDAY); // 대문자 상수 적절?
```
