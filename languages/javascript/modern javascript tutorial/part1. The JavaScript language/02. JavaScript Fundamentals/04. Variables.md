...
<img src="../../images/commons/icons/circle-exclamation-solid.svg" /> **非라틴계 언어 사용 가능 <sub>(지양)</sub>**
...
##### 일반 상수
- 런타임 과정 내 계산 <sub>(최초 할당 후 값 변경 X)</sub>
  - ex\) 웹페이지 로드 시간
```javascript
