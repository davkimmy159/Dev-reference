...
![promise-then-chain](./images/11/promise-then-chain.svg)
...
![promise-handler-variants](./images/11/promise-handler-variants.svg)
...
### <img class="icon" src="./images/commons/icons/comment-solid.svg" /> 해답
### <img class="icon" src="./images/commons/icons/message-solid.svg" /> 해답
