...
|`base`|<sub>0 ~ 9</sub>|<sub>10 ~</sub>&nbsp;|용도|
|:---:|:---:|:---:|---|
|<sub>16</sub>|<sub>0 ~ 9</sub>|<sub>A ~ F</sub>|- 16진수 색<br />- 문자 인코딩 등|
|<sub>2</sub>|<sub>0 · 1</sub>||- 연산 디버깅 등|
|<sub>36</sub>|<sub>0 ~ 9</sub>|<sub>A ~ Z</sub>|- 긴 숫자 식별자 축약 등<br />　- ex&#41; url 축약|
