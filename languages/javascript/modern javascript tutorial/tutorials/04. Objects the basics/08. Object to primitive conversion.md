...
||객체||원시값||연산||결과|
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
|(1)|obj<br /><sub>(객체)</sub>|→|"2"<br /><sub>(문자열)</sub>|→|곱셈 연산<br /><sub>(문자열 * 숫자)</sub>|→|4<br /><sub>(숫자)</sub>|
|(2)|obj<br /><sub>(객체)</sub>|→|"2"<br /><sub>(문자열)</sub>|→|이항 덧셈 연산<br /><sub>(문자열 + 숫자)</sub>|→|4<br /><sub>(문자열)</sub>|
