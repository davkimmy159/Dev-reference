...
1. `console.log(3)` 실행
   - `3`
2. `setTimeout(… 4)` <sub>(매크로태스크 큐 내 추가)</sub>
   - 매크로태스크 큐 내 추가
     1. `console.log(2)`
     2. `console.log(6)`
     3. `console.log(4)`
