...
![](../../images/02/06/02/range-methods.png)
...
<img class="icon" src="../../images/commons/icons/circle-exclamation-solid.svg" /> **Selection end may be in the document before start**
...
<img class="icon" src="../../images/commons/icons/circle-exclamation-solid.svg" /> **To select, remove the existing selection first**
