...
<img src="../../images/commons/icons/circle-exclamation-solid.svg" /> **`Selection` 끝점 → 시작점 선택 가능**
...
##### 시작점 <sub>(`anchor`)</sub> → 끝점 <sub>(`focus`)</sub> <sub>(정방향)</sub>
- `"Example"` → `"italic"`

![selection-direction-forward](../../images/02/06/02/selection-direction-forward.svg)

##### 끝점 <sub>(`focus`)</sub> ← 시작점 <sub>(`anchor`)</sub> <sub>(역방향)</sub>
- `"Example"` ← `"italic"`
