...
<img class="icon" src="../../images/commons/icons/circle-exclamation-solid.svg" /> **작은 스크립트는 먼저 다운되지만, 실행은 나중에 됩니다.**
...
<img class="icon" src="../../images/commons/icons/circle-exclamation-solid.svg" /> **defer 속성은 외부 스크립트에만 유효합니다.**
...
<img class="icon" src="../../images/commons/icons/triangle-exclamation-solid.svg" /> **스크립트 다운로드가 끝나지 않았어도 페이지는 동작해야 합니다.**
