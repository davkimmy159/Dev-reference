`DOMContentLoaded` · `load` · `beforeunload` · `unload` <sub>(이벤트)</sub>
===================================================
...
<img class="icon" src="../../images/commons/icons/triangle-exclamation-solid.svg" /> **`DOMContentLoaded`를 막지 않는 스크립트**
