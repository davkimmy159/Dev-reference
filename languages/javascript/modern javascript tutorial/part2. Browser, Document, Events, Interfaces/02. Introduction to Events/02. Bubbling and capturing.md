...
![](../../images/02/02/02/event-order-bubbling.svg)
...
<img class="icon" src="../../images/commons/icons/triangle-exclamation-solid.svg" /> **거의 모든 이벤트는 버블링 됩니다.**
...
<img class="icon" src="../../images/commons/icons/circle-exclamation-solid.svg" /> **event.stopImmediatePropagation()**
...
<img class="icon" src="../../images/commons/icons/triangle-exclamation-solid.svg" /> **꼭 필요한 경우를 제외하곤 버블링을 막지 마세요!**
...
<img class="icon" src="../../images/commons/icons/circle-exclamation-solid.svg" /> **핸들러를 제거할 때 removeEventListener가 같은 단계에 있어야 합니다.**
