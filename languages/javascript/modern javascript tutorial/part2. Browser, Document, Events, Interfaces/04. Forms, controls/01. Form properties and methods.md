...
##### 폼
- `document.forms` <sub>(특수 컬렉션)</sub> 구성원
...
<img src="../../images/commons/icons/circle-exclamation-solid.svg" /> **'하위 폼'처럼 쓰이는 `fieldset`**
...
<img src="../../images/commons/icons/triangle-exclamation-solid.svg" /> **짧은 표기법: `form.name`**
