...
We can scroll a little beyond the document start or end in some browsers/devices (empty space below is shown, and then the document will automatically “bounces back” to normal).

##### 1. 탄력성
- 문서 최상단 · 최하단 스크롤 도달 시
  1. 빈 공간 잠깐 보임 <sub>(상 · 하단 외부)</sub>
