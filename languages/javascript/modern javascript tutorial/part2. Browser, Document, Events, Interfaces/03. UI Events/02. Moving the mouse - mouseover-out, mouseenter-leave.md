...
|이벤트 <sub>(`mouse·drag`)</sub>|`target`|순서|`relatedTarget`|
|---|---|:---:|---|
|`[enter·over]`|진입 요소|←|전 이탈 요소|
|`[leave·out]`|이탈 요소|→|새 진입 요소|
