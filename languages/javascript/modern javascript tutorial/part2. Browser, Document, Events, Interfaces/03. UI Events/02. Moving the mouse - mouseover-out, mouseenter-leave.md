...
<img class="icon" src="../../images/commons/icons/triangle-exclamation-solid.svg" /> **relatedTarget can be null**
...
<img class="icon" src="../../images/commons/icons/circle-exclamation-solid.svg" /> **If mouseover triggered, there must be mouseout**
...
That’s like the task 툴팁 보여주기, but here the annotated elements can be nested. The most deeply nested tooltip is shown.
