...
- `#parent` <sub>(요소)</sub> → `#child` <sub>(요소)</sub>
  - `#parent` <sub>(요소)</sub> `mouseout` <sub>(이벤트)</sub>
  - `#child` <sub>(요소)</sub> `mouseover` <sub>(이벤트)</sub>
- `#parent` <sub>(요소)</sub> ← `#child` <sub>(요소)</sub>
  - `#parent` <sub>(요소)</sub> `mouseover` <sub>(이벤트)</sub>
  - `#child` <sub>(요소)</sub> `mouseout` <sub>(이벤트)</sub>
