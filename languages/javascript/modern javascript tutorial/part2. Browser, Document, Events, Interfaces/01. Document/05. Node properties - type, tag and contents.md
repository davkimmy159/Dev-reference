...
##### `value` <sub>(값 저장)</sub>
- `<input>` <sub>(`HTMLInputElement` 요소)</sub>
- `<select>` <sub>(`HTMLSelectElement` 요소)</sub>
- `<textarea>` <sub>(`HTMLTextareaElement` 요소)</sub>

##### `href` <sub>(`href` 속성값 저장)</sub>
- `<a>` <sub>(`HTMLAnchorElement` 요소)</sub>

##### `id` <sub>(`id` 속성값 저장</sub>
- 모든 요소 노드 <sub>(`HTMLElement` 요소)</sub>
