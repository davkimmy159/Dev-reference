...
##### 1. `document.getElementById` <sub>(메서드)</sub>
...
<img src="../../images/commons/icons/circle-exclamation-solid.svg" /> **가상 클래스 사용 가능**
...
- `className` <sub>(문자열)</sub>
  - 클래스명
- `className` <sub>(`class` 속성값)</sub> 해당 요소
  - 검색
  - 컬렉션 반환
