...
##### `class` <sub>(속성)</sub> 대응
- 값 할당 시 CSS 클래스 속성값 <sub>(문자열)</sub> 전체 변경
```html
...
<body>
  <script>
    ...
    // '' (빈 문자열)
    alert(body.style.margin);

    // 단위 (px) 명시
    // - 정상 동작
    body.style.margin = '20px';

    alert(body.style.margin);     // 20px
    alert(body.style.marginTop);  // 20px
    alert(body.style.marginLeft); // 20px
  </script>
</body>
```
