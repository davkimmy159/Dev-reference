...
- [`window.scrollBy(x,y)` <sub>(메서드)</sub>](https://developer.mozilla.org/ko/docs/Web/API/Window/scrollBy)
- [`window.scrollTo(pageX,pageY)` <sub>(메서드)</sub>](https://developer.mozilla.org/ko/docs/Web/API/Window/scrollTo)
