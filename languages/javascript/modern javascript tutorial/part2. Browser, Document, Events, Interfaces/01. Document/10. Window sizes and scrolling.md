...
##### `documentElement.client[Width · Height]`
- 스크롤바 영역 제외
  - 눈에 보이는 실제 콘텐츠 영역
...
#####  Chrome · Safari · Opera <sub>(스크롤 부재 시 값 다름)</sub>
- `documentElement.scrollHeight`는 `documentElement.clientHeight`보다 작을 때가 있죠. 예상하기엔 같은 값이어야 하는데도 말입니다.
